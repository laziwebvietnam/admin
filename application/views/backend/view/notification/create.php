...
<form id="form-submit" class="form-horizontal" action="<?=$this->_table?>/action"
    ...
    <input type="hidden" name="set_alias" value="false" />
    <div class="row">
        <div class="col-md-8">
        ...
        <div class="col-md-4">
            ...
            <div class="portlet-body form">
                <div class="form-body">
                    <?
                        create_radio('is_active',lang('is_active'),1,$data['detail']!=null?$data['detail']['is_active']:1,false,null,4);
                    ?>
                </div>
            </div>
        </div>
