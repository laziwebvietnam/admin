<?
    ...
    foreach($data['list']['data'] as $row){
        ...
        <tr class="odd gradeX">
            ...
            <td data-value-export='<?=$row['cus_fullname']?>'>
                <a href="<?=$this->_table.'/readContact/'.$row['id']?>">
                    <?=$row['cus_fullname']?>
                </a>
            </td>
            ...
            <td data-value-export='<?=sub_text(strip_tags($row['content']),100)?>'>
                <a href="<?=$this->_table.'/readContact/'.$row['id']?>">
                    <?=sub_text(strip_tags($row['content']),100)?>
                </a>
            </td>
