...
<form id="form-submit" class="form-horizontal" action="<?=$this->_table?>/action"
    ...
    <div class="row">
        <div class="col-md-8">
                        ...
                        <div class="tab-pane active" id="portlet_tab_1">
                            <div class="form-body">
                                <?
                                    ...
                                    create_textarea('desc',lang('desc'),$data['detail']['desc'],null);
                                    create_input('link',lang('link'),$data['detail']['link'],null);
                                ?>
                            </div>
                        </div>
                        <div class="tab-pane" id="portlet_tab_2">
                            <div class="form-body">
                                 <?
                                    ...
                                    create_textarea('en_desc',lang('desc'),$data['detail']['en_desc'],null);
                                    create_input('en_link',lang('link'),$data['detail']['en_link'],null);
                                 ?>
                            </div>
                        </div>
                    </div>
            ...
            <div class="portlet light bordered">
                <?
                    create_tab('Vị trí & hình ảnh');
                ?>
                <div class="portlet-body form">
                    <?
                        create_input('position',lang('position'),$data['detail']['position']);
