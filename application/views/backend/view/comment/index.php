    ...
    <div class="row">
        <div class="col-md-3">
            <div class="inbox-sidebar">
                <!--a href="comment/create" data-title="Compose" class="btn red compose-btn btn-block">
                    <i class="fa fa-edit"></i> Thêm mới 
                </a-->
                <ul class="inbox-nav">
                    <li class="<?=$slug=='inbox'?'active':''?>">
                        <a href="comment/inbox" data-type="inbox" data-title="Mới"> Bình luận mới
                            <span class="badge badge-success"><?=$data['count']['inbox']?></span>
                        </a>
                    </li>
                    <li class="<?=$slug=='noreply'?'active':''?>">
                        <a href="comment/noreply" data-type="noreply" data-title="Chưa phản hồi"> Chưa phản hồi
                            <span class="badge badge-danger"><?=$data['count']['noreply']?></span>
                        </a>
                    </li>
                    <li class="<?=$slug=='product'?'active':''?>">
                        <a href="comment/product" data-type="product" data-title="Thuộc sản phẩm"> Thuộc sản phẩm
                            
                        </a>
                    </li>
                    <li class="<?=$slug=='article'?'active':''?>">
                        <a href="comment/article" data-type="article" data-title="Thuộc bài viết"> Thuộc bài viết
                            
                        </a>
                    </li>
                    <li class="<?=$slug==''?'active':($slug=='index'?'active':'')?>">
                        <a href="comment" data-type="" data-title="Tất cả"> Tất cả
                            
                        </a>
                    </li>
                    <li class="divider"></li>
                    <li class="<?=$slug=='delete'?'active':''?>">
                        <a href="comment/delete" class="sbold uppercase" data-type="delete" data-title="Đã xóa"> Đã xóa
                            <span class="badge badge-info"><?=$data['count']['delete']?></span>
                        </a>
                    </li>
                    <li class="<?=$slug=='reply'?'active':''?>">
                        <a href="comment/reply" data-type="reply" data-title="Đã phản hồi"> Đã phản hồi
                            ...
                            <div class="dataTables_wrapper no-footer">
                                ...
                                <div class="dataTables_wrapper">
                                    <table class="table table-striped table-bordered table-hover table-checkable order-column dataTable no-footer">
                                        ...
                                        <tbody id="data-table">
                                            <? $this->load->view($this->_base_view_path.'view/comment/include/dataList'); ?>
                                        </tbody>
                                    </table>
                                </div>
