<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <a href="<?=$this->_base_url?>article">Bài viết</a>
            <i class="fa fa-circle"></i>
        </li>
        <li>
...
<!-- END PAGE BAR -->
<!-- BEGIN PAGE TITLE-->
<h3 class="page-title"> Tìm kiếm bài viết</h3>
...
<div class="m-heading-1 border-green m-bordered">
    ...
    <div class="row">
        <?
            create_input_search('title','Tên bài viết',null,'Nhập tên bài viết...',4);
        ?>
    </div>
    <div class="row">
        <?
    ...
    <div class="row">
        <?
            $array_checkbox = array(
                array('name'=>'is_special','title'=>'Bài viết nổi bật','value'=>1,'checked'=>true),
        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                ...
                <div class="dt-button-collection hidden">
                    ...
                    <a class="dt-button buttons-columnVisibility active" data-field="title"><span>Tiêu đề</span></a>
                    <a class="dt-button buttons-columnVisibility active" data-field="category"><span>Loại</span></a>
                    <a class="dt-button buttons-columnVisibility active" data-field="views"><span>Lượt xem</span></a>
                        ...
                        <table class="table table-striped table-bordered table-hover table-checkable order-column dataTable no-footer">
                            <thead>
                                ...
                                <tr id="data-table-field">
                                    ...
                                    <th data-field="views" class="sorting"> Lượt xem </th>
                                ...
                                <?
                                    for($i=1;$i<=10;$i++){
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td><a href="javascript:void(0)"> Tên bài viết #<?=$i?></a></td>
