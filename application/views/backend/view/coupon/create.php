    ...
    <div class="row">
                        ...
                        <div class="tab-pane active" id="portlet_tab_1">
                            <div class="form-body">
                                <?
                                    ...
                                    $input_value = array(
                                        array('name'=>'code','title'=>lang('code'),'val'=>$data['detail']['code']),
                                        array('name'=>'value','title'=>lang('value'),'val'=>$data['detail']['value'])
                                    );
                                    create_input_multy('Chi tiết',$input_value,true);
                                    $input_day = array(
                        ...
                        <div class="tab-pane" id="portlet_tab_2">
                            <div class="form-body">
                                 <?
                                    ...
                                    create_editor('en_desc',lang('desc'),$data['detail']['en_desc']);
                                 ?>
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-md-4">
            ...
            <div class="portlet-body form">
                <div class="form-body">
                    <?
                        create_select_('type',null,$data['detail']==null?$data['detail']['type']:$data['detail']['type'],true,$this->_template['coupon'],null,null,0);
