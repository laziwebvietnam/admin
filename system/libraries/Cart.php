...
class CI_Cart {
	...
	public function __construct($params = array())
	{
		...
		if (isset($_SESSION['cart_contents'])&&$_SESSION['cart_contents'])//$this->CI->session->userdata('cart_contents') !== FALSE)
		{
			$this->_cart_contents = $_SESSION['cart_contents'];//$this->CI->session->userdata('cart_contents');
		}
		else
		{
