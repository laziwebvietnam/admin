var AppInbox = function () {
    ...
    var initWysihtml5 = function () {
        $('.inbox-wysihtml5').wysihtml5({
            "stylesheets": ["../template/backend/assets/global/plugins/bootstrap-wysihtml5/wysiwyg-color.css"]
        });
    }
    ...
    var initFileupload = function () {
        ...
        $('#fileupload').fileupload({
            ...
            url: '../template/backend/assets/global/plugins/jquery-file-upload/server/php/',
            autoUpload: true
        });
