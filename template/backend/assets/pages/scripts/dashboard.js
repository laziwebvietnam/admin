    ...
    return {
        ...
        initCharts: function() {
            ...
            if ($('#site_statistics').size() != 0) {
                ...
                /** lazi_chart_traffic nằm ở file: index/include/chart_traffic */
            ...
            if ($('#site_activities').size() != 0) {
                ...
                /** lazi_chart_order nằm ở file: index/include/chart_order */
                var plot_statistics = $.plot($("#site_activities"),

                    [{
                        data: lazi_chart_order,
                        lines: {
                            fill: 0.2,
                            lineWidth: 0,
                        },
        ...
        initAmChart2: function() {
            ...
            var map = AmCharts.makeChart("dashboard_amchart_2", {
                type: "map",
                "theme": "light",
                pathToImages: "../template/backend/assets/global/plugins/amcharts/ammap/images/",
        ...
        initAmChart3: function() {
            ...
            var chart = AmCharts.makeChart("dashboard_amchart_3", {
                ...
                "addClassNames": true,
                "theme": "light",
                "path": "../template/backend/assets/global/plugins/amcharts/ammap/images/",
                "autoMargins": false,
                "marginLeft": 30,
                "marginRight": 8,
                "marginTop": 10,
        ...
        initWorldMapStats: function() {
            ...
            $('#mapplic').mapplic({
                source: '../template/backend/assets/global/plugins/mapplic/world.json',
                height: 265,
                animate: false,
                sidebar: false,
                minimap: false,
