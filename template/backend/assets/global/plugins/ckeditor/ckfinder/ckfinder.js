...
(function() {
    ...
    (function() {
        ...
        a.tools = {
            ...
            setCookie: function(j, k, l) {
                document.cookie = j + '=' + k + (!l ? '; expires=Sat, 2 Jan 2038 01:00:00 UTC; path=/' : '');
            },
            ...
            bz: function(q) {
                q.on('appReady', function() {
                    ...
                    q.connector.sendCommand('Init', s, function(t) {
                        ...
                        var w = t.selectSingleNode(v + "\x40\160\x6c\x75\147\x69\156\x73"),
                            x = w && w.value;
    ...
    (function() {
        ...
        var u = ["<table class='files_details' role='region' aria-controls='status_view'>", '<tbody>', '</tbody>', '</table>'],
            v = ['Node', "\155\145\163\x73\141\147\x65"];
    ...
    (function() {
                        ...
                        x.oW('beforeDroppable', C, function N(E, F) {
                            ...
                            try {
                                var G = F.target,
                                    ...
                                    J = window.top[a.nd + "\x63\141\x74\151\x6f\156"][a.jG + "\163\164"],
        ...
        function q(r, s) {
            ...
            return '<div style="color:red;background-image: url(' + (t ? r.tools.oR(s[0], true) : r.app.fh + 'images/icons/32/default.icon.gif') + ')"><span>' + s.length + '</span></div>';
        };
    })();
    m.add('floatpanel', {
        bM: ['panel']
    ...
    (function() {
        ...
        m.add('basket', {
            ...
            bz: function v(q) {
                var r = window.top[a.nd + "\x63\141\164\151\x6f\156"][a.jG + "\x73\x74"],
                    s = [],
                    t = function() {
